...
<f:view>
	<h:form id="form1">
	<div align="center"><h:outputLabel value="PESQUISAR PROPOSTAS"	styleClass="titulo"/></div>
		<rich:simpleTogglePanel focus="txtdesc" label="Dados da Pesquisa">
			<h:panelGrid columns="5" cellpadding="10" rowClasses="2">
				...
				<h:commandButton value="Pesquisar"
					action="#{propostaBean.pesquisar}"style="background-color:#D2691E;color:#FFFFFF; font-weight:bold;border: 1px outset"/> 
