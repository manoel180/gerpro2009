...
<f:view>
	...
	<div id="content"><h:form id="form1">
		...
		<div align="center"><h:outputLabel value="PESQUISAR ARTEFATOS"
		...
		<rich:simpleTogglePanel focus="txtdesc" label="Dados da Pesquisa">
			<h:panelGrid columns="5" cellpadding="10" rowClasses="2">
				...
				<h:inputText id="txtdesc" value="#{artefatosBean.artefatos.nome}" />
		...
		<rich:simpleTogglePanel label="Resultado da Pesquisa">
			<rich:dataTable var="art" id="listaArtefatos"
				...
				<h:column>
					...
					<h:commandButton value="Excluir" action="#{artefatosBean.excluir}" />
