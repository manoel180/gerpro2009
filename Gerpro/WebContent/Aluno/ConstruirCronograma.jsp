			...
			<h:form id="form1">
				<h:panelGrid columns="1">
					...
					<rich:calendar id="dt_Inicio"
						...
						showHeader="true" limitToList="true" locale="pt" disabled="#{construirPropostaBean.desabilitar}"
						minDaysInFirstWeek="6" required="true" readonly="#{construirPropostaBean.desabilitar}">
					...
					<rich:calendar id="dt_Fim"
						...
						direction="auto" firstWeekDay="1" popup="true"
						showWeekDaysBar="true" showWeeksBar="false"
						todayControlMode="scroll" datePattern="dd/M/yyyy" disabled="#{construirPropostaBean.desabilitar}"
						showHeader="true" limitToList="true" locale="pt" readonly="#{construirPropostaBean.desabilitar}"
					...
					<h:selectOneMenu id="art" value="#{construirPropostaBean.artefatos.id}" disabled="#{construirPropostaBean.desabilitar}">
					...
					<h:commandButton id="btnAdicionar" value="Adicionar" disabled="#{construirPropostaBean.desabilitar}"
	...
	<h:form id="form2">
		<rich:dataTable id="idtable" var="lstCronograma"
			...
			<h:column>
				...
				<h:commandButton image="/images/editar.png" id="btnalterar" disabled="#{construirPropostaBean.desabilitar}"
					action="#{construirPropostaBean.editCronograma}" 
					style="height: 40px; width: 40px"></h:commandButton>
			</h:column>
		</rich:dataTable>
		<div=align="right" style=" width : 864px;">
	<h:commandButton value="Salvar" id="btnsalvar" action="#{construirPropostaBean.SalvarCronograma}"  disabled="#{construirPropostaBean.desabilitar}" />
	</div>
	</h:form>
