...
public class UsuarioServiceImplTest extends TestCase {
    ...
    public void testValidaLoginUsuario() {
        ...
        FileSystemXmlApplicationContext factoryDao = new FileSystemXmlApplicationContext ( "web/WEB-INF/gerpro-data.xml" );
        FileSystemXmlApplicationContext factoryService = new FileSystemXmlApplicationContext ( "web/WEB-INF/gerpro-service.xml" );
        UsuarioService usuarioService = (UsuarioServiceImpl) factoryService.getBean("usuarioService");
        TipoUsuarioDao tipoUsuarioDao = (TipoUsuarioDao) factoryDao.getBean("tipoUsuarioDao");
