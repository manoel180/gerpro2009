...
INSERT INTO `correcao` (`id_proposta`,`id_item`,`matricula_professor`,`id_pergunta`,`observacao`,`data_correcao`,`resposta`,`id_status_correcao`) VALUES 
 (1,1,'1',4,'OK','2009-05-29',1,2),
 (1,2,'1',5,'Não está bom','2009-05-29',2,2),
 (1,3,'1',3,'Ok','2009-05-29',2,2),
 (1,4,'1',6,'Não está bom','2009-05-29',1,2),
 (1,5,'1',8,'Não está bom','2009-05-29',2,2),
 (1,6,'1',1,'OK','2009-05-30',1,2),
 (1,6,'1',2,'OK','2009-05-30',1,2),
 (1,6,'1',7,'Ok','2009-05-29',2,2);
...
INSERT INTO `lista_funcao` (`id_proposta`,`numero_sequencia`,`UC`,`descricao`,`id_item`,`Id_tipo_funcao`) VALUES 
 (1,1,'Manter Proposta','Processo de inclusão, alteração e exclusão de Proposta.',2,1),
 (1,2,'Manter Aluno','Processo de inclusão, pesquisa e alteração de Aluno.',2,1),
 (1,3,'Submeter Proposta','Submete a proposta para correção e atualiza o status.',2,1),
 (1,4,'Corrigir Proposta','Correção do artefato proposta e cálculo de seu conceito.',2,1),
 (1,5,'Submeter Correção','Submete a correção da proposta e atualiza o status.',2,1),
 (1,6,'Processar Comparativo de Conceitos','Compara os conceitos dados pelos professores que corrigem a mesma proposta em cada item da proposta.',2,1),
 (1,7,'Calcular Status de Avaliação da Proposta','Cálculo do status de avaliação da proposta com base no conceito dado aos critérios de avaliação da mesma.',2,1),
 (1,8,'Calcular Media do Status da Proposta','Cálculo do status final da proposta com base na nota que é atribuído ao status atualizado e gerado pela submissão da correção de cada professor.',2,1),
 (1,9,'Gerar Relatórios de Professores com pendências de entrega de notas','Gerar o relatório dos professores com pendências de entrega de correções.',2,1);
...
CREATE TABLE `proposta` (
  ...
  KEY `FK_proposta_1` USING BTREE (`id_status_proposta`),
...
INSERT INTO `proposta` (`id`,`nome`,`id_status_proposta`,`data_criacao`,`data_submissao`,`id_equipe`,`periodo`) VALUES 
 (1,'GerPro - Sistema de Geração e Apoio à Correção de PESw',4,'2009-04-09',NULL,1,''),
...
CREATE TABLE `proposta_item` (
  ...
  KEY `FK_proposta_item_3` USING BTREE (`id_status_criacao`),
...
INSERT INTO `proposta_item` (`id_proposta`,`id_item`,`conteudo_item`,`id_status_criacao`) VALUES 
 (1,1,'Agilizar o processo de criação de propostas pelos alunos e apoiar a correção das mesmas pelos professores.',3),
 (1,2,NULL,5),
