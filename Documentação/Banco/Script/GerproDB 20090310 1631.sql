...
INSERT INTO `proposta` (`id`,`nome`,`id_status`,`data_criacao`,`data_submissao`,`id_equipe`,`id_periodo`) VALUES 
 (1,'GerPro - Sistema de Geração e Apoio à Correção de PESw',1,'2008-01-01','0000-00-00',1,1),
 (2,'Teste 2 - Sistema de Teste do Gerpro',1,'2008-01-02','0000-00-00',2,1);
...
INSERT INTO `usuario` (`matricula`,`nome`,`id_periodo`,`id_equipe`,`id_tipo`,`senha`) VALUES 
 ...
 ('06057217','RILMAR GOMES',NULL,1,1,''),
 ('06139981','MARCELO DE SOUZA',NULL,1,1,''),
 ('06142508','MANFRINE SILVA SANTOS',NULL,1,1,'');
