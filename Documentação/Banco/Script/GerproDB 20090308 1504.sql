...
CREATE TABLE `proposta` (
  ...
  CONSTRAINT `FK_proposta_3` FOREIGN KEY (`id_periodo`) REFERENCES `periodo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `proposta` (`id`,`nome`,`id_status`,`data_criacao`,`data_submissao`,`id_equipe`,`id_periodo`) VALUES 
 (1,'GerPro - Sistema de Geração e Apoio à Correção de PESw',1,'0000-00-00','0000-00-00',1,1),
 (2,'Teste 2 - Sistema de Teste do Gerpro',1,'0000-00-00','0000-00-00',2,1);
...
CREATE TABLE `usuario` (
  ...
  KEY `FK_usuario_2` (`id_periodo`),
  KEY `FK_usuario_3` (`id_tipo`),
  CONSTRAINT `FK_usuario_1` FOREIGN KEY (`id_equipe`) REFERENCES `equipe` (`id`),
  CONSTRAINT `FK_usuario_2` FOREIGN KEY (`id_periodo`) REFERENCES `periodo` (`id`),
...
INSERT INTO `usuario` (`matricula`,`nome`,`id_periodo`,`id_equipe`,`id_tipo`,`senha`) VALUES 
 ('0','teste',NULL,NULL,3,'0'),
 ('00000000','ÁUREA MELO',NULL,NULL,2,''),
 ('06057217','RILMAR GOMES',NULL,NULL,1,''),
 ('06139981','Marcelo de Souza',NULL,NULL,1,''),
 ('06142508','MANFRINE SILVA SANTOS',NULL,NULL,1,'');
