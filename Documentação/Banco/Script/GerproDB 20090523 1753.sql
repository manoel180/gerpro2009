...
INSERT INTO `correcao` (`id_proposta`,`id_item`,`matricula_professor`,`id_pergunta`,`observacao`,`data_correcao`,`resposta`) VALUES 
 (1,1,'1',4,'Teste de correcao','2009-05-11',1),
 (1,1,'2',4,'Teste de correcao','2009-05-11',1),
 (2,1,'1',4,'Teste de correcao','2009-05-11',1),
 (12,1,'1',1,'Ta otimo','2009-06-01',1),
 (12,1,'1',7,'melhorar','2009-06-01',1),
 (12,1,'2',1,'Precisa melhorar','2009-06-02',1),
 (12,1,'2',7,'Dá para o gasto','2009-06-02',1),
 (12,1,'3',1,'Ficou bom','2009-06-03',1),
 (12,1,'3',7,'Forma logo','2009-06-03',1),
 (12,2,'1',2,'Ta legal','2009-06-01',1),
 (12,2,'2',2,'Otimo','2009-06-02',1),
 (12,2,'3',2,'Aprendeu comigo','2009-06-03',2),
 (12,3,'1',3,'Ta blz','2009-06-01',1),
 (12,3,'2',3,'Nao sei se passo','2009-06-02',1),
 (12,3,'3',3,'Melhorar o Portugues','2009-06-03',1),
 (12,4,'1',4,'Ta file','2009-06-01',1),
 (12,4,'2',4,'Vai passar','2009-06-02',1),
 (12,4,'3',4,'Muito erros infantiis','2009-06-03',1),
 (12,5,'1',5,'Ta mara','2009-06-01',1),
 (12,5,'2',5,'Tomara que passe','2009-06-02',1),
 (12,5,'3',5,'To com pena','2009-06-03',2),
 (12,6,'1',6,'Ta passou','2009-06-01',1),
 (12,6,'2',6,'Melhou um pouco','2009-06-02',1),
 (12,6,'3',6,'Passa logo','2009-06-03',2);
...
INSERT INTO `cronograma` (`id_proposta`,`id_item`,`nome_item`,`data_inicial`,`data_final`,`numero_sequencia`) VALUES 
 (12,5,'Analise','2009-01-31','2009-02-18',1),
 (12,5,'Implementação','2009-03-29','2009-05-18',2),
 (12,5,'Documentacao','2009-02-27','2009-07-01',3);
...
INSERT INTO `lista_funcao` (`id_proposta`,`numero_sequencia`,`UC`,`descricao`,`id_item`,`Id_tipo_funcao`) VALUES 
 (12,1,'Manter Aluno','Cadastrar Aluno para passar de ano',2,1),
 (12,2,'Manter Minha Cidade','Cadastrar Tapiramuta',2,1),
 (12,3,'Processar Professora','Zelar do Professor pois ele irá me ajudar',2,2),
 (12,4,'Relatorio','Relatorio de todos os alunos aprovados',2,3);
...
INSERT INTO `proposta` (`id`,`nome`,`id_status`,`data_criacao`,`data_submissao`,`id_equipe`,`periodo`) VALUES 
 ...
 (4,'Flamengo - campeao de novo de novo de novo de novo de novo de novo de novo de novo de novo',1,'2009-04-09',NULL,2,' '),
 (5,'TesteCreateProposta',1,'2009-04-09',NULL,6,' '),
 (6,'TesteUnitarioDeProposta',1,'2009-04-15',NULL,6,'2009/01'),
 (11,'TesteUnitarioDeProposta2',1,'2009-04-15',NULL,6,'2009/01'),
 (12,'Formacao',1,'2009-05-19',NULL,1,'2009/01');
...
INSERT INTO `proposta_item` (`id_proposta`,`id_item`,`conteudo_item`,`id_status`) VALUES 
 ...
 (2,5,NULL,1),
 (2,6,NULL,1),
 (12,1,'Formar para vencer',6),
 (12,2,NULL,6),
 (12,3,'Eu quero me formar',6),
 (12,4,'Pelo Amor de Deus',6),
 (12,5,NULL,6),
 (12,6,NULL,6);
...
INSERT INTO `usuario` (`matricula`,`nome`,`id_equipe`,`id_tipo`,`senha`) VALUES 
 ...
 ('1','Professor de Teste',NULL,2,'1'),
 ('2','ÁUREA MELO',NULL,2,'2'),
 ('3','Anderson Esteves',NULL,2,'123');
